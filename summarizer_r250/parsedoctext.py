"""
Copied from the original `python` folder of the repo.
...
def main_parse(args):
    ...
    # stores the output
    times = []
    for (_, attrs), (trees, dt) in itertools.izip(docs, result):
...
def argparser(parser=None, func=main_parse):
    if parser is None:
    ...
    parser.add_argument('--parser', type=str, 
            default='./stanford-parser-full-2014-10-31/stanford-parser.jar',
            help='Path to Stanford parser (jar)')
    parser.add_argument('--models', type=str, 
            default='./stanford-parser-full-2014-10-31/stanford-parser-3.5.0-models.jar',
            help='Path to Stanford parser models (jar)')
    parser.add_argument('--grammar', type=str, 
            default='./stanford-parser-full-2014-10-31/englishPCFG.ser.gz',
...
if __name__ == '__main__':
    main_parse(args = argparser().parse_args())
